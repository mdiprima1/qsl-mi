...
**Version 1.3.1** · The canonical strategy packages for the QSL course **Modern Investing for Everyone** (Quantitative Strategy Lab, quantstrategylab.com).
...
---
© Quantitative Strategy Lab. Educational materials for the QSL course; not investment advice.
